...
OUTPUT_DIR=$BASE_DIR/output/ismipC/ismipC_inv2_perbc_20x20_crossed
...
python run_inv.py -b -x $NX -y $NY -m 25 -p 0  -r $RC1 $RC2 $RC3 $RC4 $RC5 -d $INPUT_DIR -o $OUTPUT_DIR
