...
This section will plot the results of the IsmipC experiments. It assumes you ran all the simulations in {\tt ismipc/scripts/}. If not, you'll need to execute {\tt run\_all.sh} in that folder. The timings on the same machine as previously are as follow:

real    \hspace{10mm}91m2.137s           \\                                                                                            
user   \hspace{8mm} 343m51.234s      \\                                                                                               
sys     \hspace{11mm}218m52.578s    \\
