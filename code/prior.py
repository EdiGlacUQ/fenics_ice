...
from sqrt_mass_matrix_action import A_root_action
...
class laplacian(object):
    ...
    def inv_mass_action(self,x):
        y = x
        self.M_solver.solve(x, y) #Atmp2 = tmp1
        
    def action(self, x, y):  # inverse covariance
    ...
    def inv_action(self, x, y): # covariance: A-1 M A-1
