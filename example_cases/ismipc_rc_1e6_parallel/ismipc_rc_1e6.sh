...
mpirun -n 2 python $RUN_DIR/run_inv.py ismipc_rc_1e6.toml
mpirun -n 2 python $RUN_DIR/run_forward.py ismipc_rc_1e6.toml
mpirun -n 2 python $RUN_DIR/run_eigendec.py ismipc_rc_1e6.toml
