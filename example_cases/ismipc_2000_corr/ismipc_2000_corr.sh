...
python $RUN_DIR/run_inv.py ismipc_2000_corr.toml
python $RUN_DIR/run_forward.py ismipc_2000_corr.toml
python $RUN_DIR/run_eigendec.py ismipc_2000_corr.toml
#python $RUN_DIR/run_errorprop.py ismipc_2000_corr.toml
python $RUN_DIR/run_invsigma.py ismipc_2000_corr.toml
#python $RUN_DIR/run_sample_post.py ismipc_2000_corr.toml
